...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "Maria@gmail.com", new DateTime(1989, 9, 1), 3500.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "Alex@gmail.com", new DateTime(1972 ,1, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "Martha@gmail.com", new DateTime(1985, 7, 11), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "Donald@gmail.com", new DateTime(2000, 2, 15), 4000.0, d3);
            Seller s6 = new Seller(6, "Alex Pink", "Pink@gmail.com", new DateTime(1997, 6, 9), 3000.0, d2);
            ...
            _context.SalesRecords.AddRange(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13,
